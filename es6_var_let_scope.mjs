...
where F is the value of temperature in Fahrenheit, and C is the 
...
<html>
  ...
  <body>
    <!-- Only change code below this line -->
    <script type="module" src="index.js"></script> //script type = "module" written in html file
    <!-- Only change code above this line -->
  </body>
</html>
*/
...
/*The following function should be the fallback
 value for the module. Please add the necessary code to do so.
*/
...
/*Make the promise handle success and failure.
 If responseFromServer is true, call the resolve method to 
 successfully complete the promise. Pass resolve a string with 
 the value We got the data. If responseFromServer is false, use 
...
*/
const mServerRequest = new Promise((resolve, reject) => {
...
mServerRequest.then(result => {
      console.log(result);
    });

//Handle a Rejected Promise with catch
/*Add the catch method to your promise. Use error as
 the parameter of its callback function and log error to the console.
*/

const akeServerRequest = new Promise((resolve, reject) => {
...
akeServerRequest.then(result => {
  console.log(result);
});

akeServerRequest.catch(error => {
      console.log(error);
    });
